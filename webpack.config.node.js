...
module.exports = {
	...
	plugins: [
		...
		new webpack.NormalModuleReplacementPlugin( /^state$/, 'components/empty-component' ), // Depends on BOM
		new webpack.NormalModuleReplacementPlugin( /^components\/web-preview$/, 'components/empty-component' ) // Depends too much on page.js
	],

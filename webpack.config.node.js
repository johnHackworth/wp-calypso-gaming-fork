...
module.exports = {
	...
	plugins: [
		...
		new webpack.NormalModuleReplacementPlugin( /^components\/web-preview$/, 'components/empty-component' ),
		new webpack.NormalModuleReplacementPlugin( /^components\/seo-preview-pane$/, 'components/empty-component' )
	],
